        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            ...
            <div class="card card-success" style="border-radius: 20px;">
              <br>
              <div class="card-header"><h2 class="text-success">CEK SPP</h2></div>
              <div class="card-body">
                <form method="POST" action="/prosesloginsiswa" class="needs-validation" novalidate="">
                  @csrf
                  <div class="form-group">
                    <label for="nisn">NISN</label>
                    <input id="nisn" type="nisn" class="form-control" name="nisn" tabindex="1" required autofocus autocomplete="off">
                    <div class="invalid-feedback">
                      Mohon masukan NISN anda
                    </div>
                  </div>



                  <input id="nama" type="hidden" class="form-control" value="password" name="password" tabindex="2" required autocomplete="off">
