      ...
      {{-- Nama SPP --}}
        <div class="col-md-6">
            <div class="form-group">
              ...
              <input type="text" name="nama_spp" value="{{old('nama_spp')}}" class="form-control" autocomplete="off">  
            </div>
          </div>
        ...
        <div class="col-md-6">
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input type="number" name="nominal" value="{{old('nominal')}}" class="form-control" autocomplete="off">  
            </div>
          </div>              
