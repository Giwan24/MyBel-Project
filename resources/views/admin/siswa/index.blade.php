      ...
      <div class="card mt-3" style="box-shadow: 0 4px 8px rgba(0, 0, 0, 0.2);">
        <div class="card-body">
          ...
          @if (Auth::guard('admin')->user()->level == 'admin')
            {{-- Button tambah --}}
          <a href="{{ route('siswa.create') }}" class="btn btn-icon icon-left btn-success mb-3 px-3 text-white"><h6><i class="fas fa-plus"></i> Tambah Data</h6></a>  
          @endif
            ...
            <tbody class="mt-2">
              ...
              <tr>
                ...
                <td>
                  ...
                  <a href="{{ route('siswa.history',$item->nisn) }}" class="btn btn-warning mt-2"> RIWAYAT </a>
              </td>
            </tr>
            @push('page-scripts')
