  ...
  <div class="row">
    <div class="col-md-12">
        ...
        <div class="card-body">
          ...
          <a href="{{ route('petugas.create') }}" class="btn btn-icon icon-left btn-success mb-3 px-3 text-white"  style="border-radius: 15px;"><h6><i class="fas fa-plus"></i> Tambah Data</h6></a>
    ...
    <div class="col-md-12">
      <div class="card" style="box-shadow: 0 4px 8px rgba(0, 0, 0, 0.2); border-radius: 20px;">
        <div class="card-body">
          {{-- USER --}}
          <br>
          <h3><img alt="image" src="{{ asset('assets/img/avatar/avatar-2.png') }}" width="30px" class="rounded-circle mr-1" style="margin-bottom:5px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.37);">   Admin</h3><br>
          @if(session('message'))
